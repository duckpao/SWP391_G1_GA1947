...
public class InventoryReport {
    ...
    // For supplier-level inventory
    private int supplierId;
    private String supplierName;
    private int medicineTypes;

    // For batch-level inventory
    private int batchId;
    ...
    // Medicine-level Getters & Setters
    ...
    // Supplier-level Getters & Setters
