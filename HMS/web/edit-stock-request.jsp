    ...
    <head>
        ...
        <style>
            * {
            ...
            .header {
                background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); /* Thay đổi */
                color: white;
                padding: 30px 40px;
            }
...
textarea:focus {
    outline: none;
    border-color: #3b82f6; /* Thay đổi */
    background: white;
    box-shadow: 0 0 0 4px rgba(59, 130, 246, 0.1); /* Thay đổi */
}
            ...
            .medicine-item {
    background: white; /* Thay đổi */
    border: 2px solid #3b82f6; /* Thay đổi */
    border-radius: 12px;
    padding: 24px;
    margin-bottom: 20px;
    transition: all 0.3s ease;
...
.medicine-item:hover {
    border-color: #2563eb; /* Thay đổi */
    box-shadow: 0 4px 12px rgba(59, 130, 246, 0.2); /* Thay đổi */
}
    ...
    margin-bottom: 20px;
    padding-bottom: 12px;
    border-bottom: 2px solid #e5e7eb; /* Thay đổi */
}

.medicine-item-title {
    font-weight: 700;
    color: #1f2937; /* Thay đổi */
    font-size: 16px;
    display: flex;
    align-items: center;
    gap: 8px;
...
.btn-add-medicine:hover {
    background: #2563eb; /* Thay đổi */
    transform: translateY(-2px);
    box-shadow: 0 8px 20px rgba(59, 130, 246, 0.3); /* Thay đổi */
}
...
.total-label {
    font-size: 18px;
    font-weight: 700;
    color: #1e40af; /* Thay đổi */
}

.total-amount {
    font-size: 24px;
    font-weight: 700;
    color: #3b82f6; /* Thay đổi */
}
