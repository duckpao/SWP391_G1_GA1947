        ...
        <div class="info-alert">
            ...
            <div class="info-alert-content">
                ...
                <div class="info-alert-text">
                    Update the carrier and tracking number when there are changes to your shipment. The hospital will be notified of any updates.
                </div>
            </div>
        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-value">
                            ...
                            Current Carrier: <strong>${asn.carrier}</strong>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-value">
                            <i class="bi bi-arrow-right"></i>
                            Current Tracking: <strong>${asn.trackingNumber}</strong>
                        </div>
                    </div>
                </div>
