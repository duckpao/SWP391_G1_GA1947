        ...
        <div class="page-wrapper">
                ...
                <div class="menu">
                    <c:choose>
                        ...
                        <c:when test="${sessionScope.role eq 'Admin'}">
                            <c:choose>
                                <%-- Kiểm tra tham số dashboard TRƯỚC --%>
                                <c:when test="${param.dashboard eq 'pharmacist'}">
                                    <a href="${pageContext.request.contextPath}/view-medicine?dashboard=pharmacist">
                                        <i class="bi bi-capsule"></i> Quản lý thuốc
                                    </a>
                                    <a href="${pageContext.request.contextPath}/pharmacist/View_MedicineRequest?dashboard=pharmacist">
                                        <i class="bi bi-file-earmark-plus"></i> Yêu cầu thuốc
                                    </a>
                                    <a href="${pageContext.request.contextPath}/pharmacist/manage-batch?dashboard=pharmacist">
                                        <i class="bi bi-box-seam"></i> Quản lý số lô/lô hàng
                                    </a>
                                    <a href="${pageContext.request.contextPath}/pharmacist/recordExpiredDamaged?dashboard=pharmacist">
                                        <i class="bi bi-exclamation-triangle"></i> Thuốc hết hạn/hư hỏng
                                    </a>
                                    <a href="${pageContext.request.contextPath}/report?dashboard=pharmacist">
                                        <i class="bi bi-graph-up"></i> Báo cáo thống kê
                                    </a>
                                </c:when>

                                <%-- Mặc định: Doctor view --%>
                                <c:otherwise>
                                    <a href="${pageContext.request.contextPath}/view-medicine?dashboard=doctor" class="active">
                                        <i class="bi bi-capsule"></i> Quản lý thuốc
                                    </a>
                                    <a href="${pageContext.request.contextPath}/create-request?dashboard=doctor">
                                        <i class="bi bi-file-earmark-plus"></i> Yêu cầu thuốc
                                    </a>
                                </c:otherwise>
                            </c:choose>
            ...
            <div class="main">
                ...
                <div class="d-flex mb-3 gap-2">
                    <c:choose>
                        <%-- Doctor view: Chỉ có nút Create Request --%>
                        <c:when test="${sessionScope.role eq 'Doctor'}">
                        ...
                        <%-- Admin với dashboard=doctor: Chỉ có nút Create Request --%>
                        <c:when test="${sessionScope.role eq 'Admin' and param.dashboard eq 'doctor'}">
                            <a href="${pageContext.request.contextPath}/create-request?dashboard=doctor" class="btn btn-primary">
                                <i class="bi bi-file-earmark-plus"></i> Create Request
                            </a>
                        </c:when>

                        <%-- Pharmacist hoặc Admin với dashboard=pharmacist: Có nút Add Medicine --%>
                        <c:otherwise>
                            <c:if test="${sessionScope.role eq 'Pharmacist' || (sessionScope.role eq 'Admin' and param.dashboard eq 'pharmacist')}">
                            ...
                            <table class="table table-hover align-middle text-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <%-- Chỉ hiển thị cột Edit/Delete cho Pharmacist hoặc Admin với dashboard=pharmacist --%>
                                        <c:if test="${sessionScope.role eq 'Pharmacist' || (sessionScope.role eq 'Admin' and param.dashboard eq 'pharmacist')}">
                                            <th>Chỉnh sửa</th>
                                            <th>Xóa</th>
                                            </c:if>
                                ...
                                <tbody>
                                    <c:forEach var="m" items="${medicines}">
                                        <tr>
                                            ...
                                            <%-- Chỉ hiển thị nút Edit/Delete cho Pharmacist hoặc Admin với dashboard=pharmacist --%>
                                            <c:if test="${sessionScope.role eq 'Pharmacist' || (sessionScope.role eq 'Admin' and param.dashboard eq 'pharmacist')}">
                                                <td>
