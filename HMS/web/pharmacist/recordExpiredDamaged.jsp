        ...
        <div class="page-wrapper">
            ...
            <div class="main">
                ...
                <div class="form-container">
                    <form action="${pageContext.request.contextPath}/pharmacist/recordExpiredDamaged" method="post" class="row g-3 align-items-end">

                        <!-- Cột chọn thuốc -->
                        <div class="col-md-5">
                            <label class="form-label fw-semibold">Thuốc (Số lô)</label>
                            <select id="batchSelect" name="batchId" class="form-select" required>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="notes" class="form-control" placeholder="Tùy chọn">
                        </div>
